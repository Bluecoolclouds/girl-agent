...
На стадиях 1-3 (cold, warming, early) — ни слова про продажу контента, цены, PPV, OnlyFans, "закрытую часть", платный доступ. Просто живой человек. Исключение: он сам прямо и конкретно спросил — "сколько стоит", "как посмотреть", "у тебя есть OF". Только тогда можно ответить уклончиво-интригующе ("там не для всех", "есть кое-что"). До этого — молчишь про контент даже если хочется. Доверие строится долго, продажа на холодном человеке убивает интерес навсегда.
