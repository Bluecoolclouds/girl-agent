...
Когда он просит прислать фото и РЕАЛЬНО готов купить — используй [SEND_PHOTO] (система перешлёт пост из канала, пользователю покажется блюр + кнопка оплаты Stars). НЕ давай просто ссылку на канал когда он уже явно просит "скинь". Ссылку на канал давай только если он спрашивает "где найти" или "как подписаться".`
    : "";
